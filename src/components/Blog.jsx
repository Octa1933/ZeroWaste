          ...
          <div className="container" data-aos="fade-up">
            <div className="row gy-4 align-items-center">
              ...
              <div className="col-lg-6">
                <img src="assets/img/berita1.jpeg" alt className="img-fluid" />
              </div>
              <div className="col-lg-6">
                <h3>
                  TPST Ngurah Rai Denpasar Ditutup karena Tak Mampu Olah Sampah
                  Lagi
                </h3>
                <p>Kamis, 25 Maret 2024 National Geographic Indonesia</p>
                <h6 style={{ textAlign: "justify", fontSize: 19 }}>
                  Tempat pengolahan sampah terpadu (TPST) Tahura Ngurah Rai,
                  Denpasar, Bali ditutup karena tidak mampu mengolah sampah.
                  Wali Kota Denpasar I Gusti Ngurah Jaya Negara mengaku telah
                  dipanggil pemerintah pusat terkait penutupan TPST Tahura
                  Ngurah Rai. "Tinggal yang di (TPST Kesiman) Kertalangu kalau
                  juga tidak maksimal akan kami ganti dan tutup sesuai dengan
                  ketentuan yang berlaku," ujar Jaya Negara di Gedung Dharma
                  Negara Alaya, Denpasar, Bali, Kamis (21/3).
                </h6>
